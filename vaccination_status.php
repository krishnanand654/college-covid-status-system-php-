...
if(isset($_POST['search'])){
    $x=$_POST['id'];
    $sql = "SELECT vacdetails.id, vacdetails.vacstatus, vacdetails.vacdate,vacdetails.dos, student.reg_num from student INNER JOIN vacdetails ON vacdetails.id = student.id where vacdetails.id= '$x' or student.reg_num = '$x'; ";
    $result = mysqli_query($conn, $sql);
    $row=mysqli_num_rows($result);

}else{?>
<?php
$sql = "SELECT vacdetails.id, vacdetails.vacstatus, vacdetails.vacdate, vacdetails.dos, student.reg_num from student INNER JOIN vacdetails ON vacdetails.id = student.id";
$result = mysqli_query($conn, $sql);
$row = mysqli_num_rows($result);
}?>
